...
export function EditAssetDialog({ open, onOpenChange, item, onSave }: EditAssetDialogProps) {
  ...
  const needsMetal = () => {
    return formData && ['GOLD', 'SILVER', 'JEWELRY', 'WATCH'].includes(formData.type);
  };

  const needsCrypto = () => {
    return formData && formData.type === 'CRYPTO';
  };

  const needsLoan = () => {
    return formData && formData.type === 'LOAN_RECEIVABLE';
  };
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            {needsMetal() && (
              <>
                ...
                <div>
                  <Label htmlFor="estimatedValue">Or Estimated Value</Label>
                  <Input
                    type="number"
                    step="0.01"
                    min="0"
            ...
            {needsCrypto() && (
              <>
                ...
                <div>
                  <Label htmlFor="totalValue">Or Total Value</Label>
                  <Input
                    type="number"
                    step="0.01"
                    min="0"
